    ...
    if not args.name:
        ...
        for size in list_windows_size:
            ...
            if args.model == "Transformer":
                _input_size=(model_args[args.name]["model_args"]["{}_n_class".format("red")])*model_args[args.name]["model_args"]["windows_size"]
                ...
                _output_size=model_args[args.name]["model_args"]["{}_sequence_len".format("red")]*model_args[args.name]["model_args"]["{}_n_class".format("red")]
            run_predict(window_size=int(size), \
                        sequence_len=model_args[args.name]["model_args"]['red_sequence_len'], \
